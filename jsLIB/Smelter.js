...
BERING.ore = (function () {
    var _aspire;
    function aspireFurther() {
        var items = [];
        items.push(makeItem(1, 111.5, 181, 68, "R", 0, "I sometimes feel ashamed of myself", 63, "e", "", false, 0, 12));
        items.push(makeItem(2, 118, 170, 56, "R", 0, "I don't look after myself", 53, "e", "e", false, 0, 20));
        items.push(makeItem(3, 122.5, 162, 48, "R", 0, "I sometimes feel humiliated", 52, "e", "", false, 0, 3));
        ...
        items.push(makeItem(6, 181, 178.5, 84, "C", 2, "If I have a problem, I won’t speak to anyone in college", 66, "e", "", false, 0, 17));
        items.push(makeItem(7, 178.5, 174, 78, "C", 2, "I give up easily", 61, "e", "", false, 0, 6));
        items.push(makeItem(8, 170, 156.6, 59.5, "C", 2, "I often know the answer but don`t put my hand up", 65, "e", "", false, 0, 1));
        items.push(makeItem(9, 168, 152, 54.5, "C", 2, "I find it hard to ask for help", 62, "e", "", false, 0, 22));
        items.push(makeItem(10, 166, 147.5, 49.5, "C", 2, "I'm not ambitious", 49, "e", "", false, 0, 15));
        items.push(makeItem(11, 162, 143.4, 50, "C", 2, "I won't try things if I might look stupid", 90, "e", "", false, 0, 16));
        ...
        items.push(makeItem(17, 203.5, 135.5, 83, "C", 4, "I don't know what I'm good at", 56, "e", "", false, 0, 11));
        items.push(makeItem(18, 196, 94, 132, "C", 4, "My worries often distract me", 67, "e", "", false, 0, 18));
        ...
        items.push(makeItem(21, 192, 106, 37, "L", 6, "I copy what other people do", 56, "e", "", false, 0, 23));
        ...
        items.push(makeItem(27, 193, 80.5, 66, "L", 8, "I would say nothing if the lecturer made a mistake", 69, "e", "", false, 0, 29));
        ...
        items.push(makeItem(31, 186, 64, 50, "L", 8, "If I get a row from a lecturer, I take it", 93, "e", "", false, 0, 27));
        ...
        items.push(makeItem(39, 184, 30.6, 46, "L", 8, "I get on with the people in my course", 95, "e", "", false, 0, 44));
        ...
        items.push(makeItem(44, 201, 6, 50, "L", 8, "I care about how lecturers are feeling", 92, "e", "", false, 0, 31));
        ...
        items.push(makeItem(47, 120, 32, 58, "R", 9, "I get on well with my lecturers", 83, "e", "", false, 0));
        ...
        items.push(makeItem(53, 71, 9, 25, "R", 7, "I look after myself", 2, "i", "", false, 0, 20));
        items.push(makeItem(54, 58, 13.6, 42, "", 7, "I'm good at making my mind up", 22, "i", "", false, 0, 13));
        items.push(makeItem(55, 52, 18, 51, "R", 7, "I know who to go to if I have a problem", 14, "i", "", false, 0, 10));
        ...
        items.push(makeItem(65, 61, 59.5, 53, "R", 7, "If I disappeared the course would miss me", 8, "i", "", false, 0, 1));
        ...
        items.push(makeItem(69, 40, 75.5, 65, "R", 7, "I would correct the lecturer if they made a mistake", 27, "i", "", false, 0, 29));
        items.push(makeItem(70, 66, 84, 37, "R", 7, "I pay attention to how I look", 20, "i", "", false, 0, 19));
        items.push(makeItem(71, 67, 79.5, 37, "R", 7, "I allways want to be the best", 25, "i", "", false, 0, 30));
        ...
        items.push(makeItem(76, 60.8, 106, 44, "R", 5, "I get jealous when others are center stage", 40, "i", "", false, 0, 25));
        ...
        items.push(makeItem(83, 11, 158.2, 49, "C", 3, "I think I can get away with anything", 47, "i", "", false, 0, 48));
        items.push(makeItem(84, 11, 163, 40, "C", 3, "I enjoy annoying lecturers", 42, "i", "", false, 0, 33));
        items.push(makeItem(85, 101, 135.5, 32, "C", 1, "I don't know anything about the people in my course", 26, "i", "", false, 0, 43));
        ...
        items.push(makeItem(89, 51, 167.5, 66, "C", 1, "I get bored a lot at college and show it", 32, "i", "", false, 0, 46));
        items.push(makeItem(90, 44, 171.5, 70.5, "C", 1, "People think I can be rude", 11, "i", "", false, 0, 16));
        items.push(makeItem(91, 38, 175.5, 75, "C", 1, "I don't get on well with my lecturers", 12, "i", "", false, 0, 2));
        items.push(makeItem(92, 31.5, 179.5, 78, "C", 1, "I find it hard to fit in", 44, "i", "", false, 0, 31));
        items.push(makeItem(93, 136, 138, 23, "L", 0, "If I get a row from a lecturer I get angry", 31, "i", "", false, 0, 27));
...
//        items.push(makeItem(96, 130, 158, 40, "L", 0, "I get spiteful and angry with others who do better than me", 48, "i", "", false, 0, 42));//128
