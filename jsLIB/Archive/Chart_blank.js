    ...
    function percentages(doc) {
        ...
        for (var i = 0; i < store.length; i++) {
            ...
            switch (store[i][0]) {
                case 0:
                    doc.setFontSize(20);
                    doc.text(String(stance[0].t), stance[0].x, stance[0].y - 0, 'right');
//                    doc.setFontSize(12);
...
//                    doc.text('Quadrant share of ratings: ' + String(store[i][4] + "%"), stance[0].x, stance[0].y, 'right');
                ...
                case 1:
                    doc.setFontSize(20);
                    doc.text(String(stance[1].t), stance[1].x, stance[1].y + 2, 'right');
//                    doc.setFontSize(12);
...
//                    doc.text('Quadrant share of ratings: ' + String(store[i][4] + "%"), stance[1].x, stance[1].y, 'right');
                ...
                case 2:
                    doc.setFontSize(20);
                    doc.text(String(stance[2].t), stance[2].x, stance[2].y + 2);
//                    doc.setFontSize(12);
...
//                    doc.text('Quadrant share of ratings: ' + String(store[i][4] + "%"), stance[2].x, stance[2].y);
                ...
                case 3:
                    doc.setFontSize(20);
                    doc.text(String(stance[3].t), stance[3].x, stance[3].y - 0);
//                    doc.setFontSize(12);
