...
//        tmp.align = a;
    ...
    function makeItem(p, x, y, w, a, s, t, pr, ie, com, rf, ava, aIn,trss,smft) {
//        var align;
//        if (a === "R") {
//            align = 'right';
//        } else if (a === "C") {
...
//        item.aVa = ava;
        ...
        return BERING.Miner.pick(p, x, y, w, a, s, t, pr, ie, com, rf, ava, aIn,trss,smft);
    }
    function getBlank() {
