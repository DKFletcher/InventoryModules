...
BERING.Miner = (function () {
    function aspire() {
        ...
        items.push(makeItem(6, 210, 177, 40, "C", 2, "If I have a problem, I won’t speak to any adult in school", 66, "e", "", false, 0, 17));
        items.push(makeItem(7, 212, 173, 30, "C", 2, "I give up easily", 61, "e", "", false, 0, 6));
        items.push(makeItem(8, 202, 166, 40, "C", 2, "I often know the answer but don`t put my hand up", 65, "e", "", false, 0, 1));
        ...
        items.push(makeItem(13, 240, 153, 60, "C", 4, "I take things to heart and get upset easily", 72, "e", "", false, 0, 14));
        ...
        items.push(makeItem(80, 70, 137, 40, "C", 3, "I make hurtful comments when I'm joking with people", 35, "i", "", false, 0, 45));
        items.push(makeItem(81, 70, 144, 50, "C", 3, "I get others into trouble", 28, "i", "", false, 0, 36));
        items.push(makeItem(82, 60, 148, 50, "C", 3, "No-one would want to get on the wrong side of me", 30, "i", "", false, 0, 39));
        items.push(makeItem(83, 60, 155, 50, "C", 3, "I talk when the teacher is speaking", 47, "i", "", false, 0, 48));
        items.push(makeItem(84, 60, 159, 50, "C", 3, "I enjoy annoying teachers", 42, "i", "", false, 0, 33));
        
        items.push(makeItem(85, 107, 142, 25, "L", 1, "I don't know anything about the people in the class", 26, "i", "", false, 0, 43));
        items.push(makeItem(86, 108, 153, 38, "C", 1, "I get huffy if I don't get my own way", 43, "i", "", false, 0, 34));
        items.push(makeItem(87, 104, 160, 38, "C", 1, "I get impatient with others", 41, "i", "", false, 0, 32));
        items.push(makeItem(88, 99, 164.5, 38, "C", 1, "I can take myself too seriously", 33, "i", "", false, 0, 47));
        items.push(makeItem(89, 94, 169, 50, "C", 1, "I get bored a lot at school and show it", 32, "i", "", false, 0, 46));
        items.push(makeItem(90, 89, 173.5, 50, "C", 1, "People think I can be rude", 11, "i", "", false, 0, 16));
        items.push(makeItem(91, 79, 178, 50, "C", 1, "I don't like my teachers", 12, "i", "", false, 0, 2));
        items.push(makeItem(92, 79, 182.5, 50, "C", 1, "I find it hard to fit in", 44, "i", "", false, 0, 31));
        ...
        stance.push(makeStance(3, 33, 165, 'TAKING OVER', 50));
        stance.push(makeStance(4, 250, 163, 'TAKING THINGS TO HEART', 40, "center"));
